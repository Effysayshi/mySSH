            ...
            <div class="row-fluid">
                ...
                <div class="block">
                    <div class="navbar navbar-inner block-header">
                        <div class="muted pull-left">读后感列表</div>
                    </div>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example2">
                                ...
                                <s:iterator value="list" var="d">
                                    <tr class="odd gradeX">
                                        ...
                                        <td class="center"><a href="novel_managerCheckD?id=<s:property value="#d.id"/>">查看</a> | <a href="novel_deleteD?id=<s:property value="#d.id"/>">删除</a></td>
                                    </tr>
                                </s:iterator>
                                </tbody>
                            </table>
