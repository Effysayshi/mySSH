                ...
                <ul class="nav pull-right">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <a tabindex="-1" href="register.jsp">注册</a>
                            </li>
                            <li class="divider"></li>
                            <li>
                                <a tabindex="-1" href="login.jsp">登陆</a>
                            </li>
                        </ul>
                    </li>
                </ul>
    ...
    <div class="row-fluid">
        ...
        <div class="block">
            ...
            <div class="block-content collapse in">
                <div class="span12">
                    <!-- BEGIN FORM-->
                    <s:form action="author_add" method="POST" id="form_sample_1" class="form-horizontal" theme="simple" namespace="/">
                        <fieldset>
                            <div class="control-group">
                                <label class="control-label">用户名<span class="required">*</span></label>
                                <div class="controls"><input type="text" name="authname" data-required="1" class="span6 m-wrap"/></div>
                            </div>
                            <div class="control-group">
                                <label class="control-label">密码<span class="required">*</span></label>
                                <div class="controls">
                                    <input type="password" name="authpassword" data-required="1" class="span6 m-wrap"/>
                                </div>
                            </div>
                            <div class="control-group">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls"><input name="age" type="number" class="span6 m-wrap"/></div>
                            </div>
                            <div class="control-group">
                                <label class="control-label">邮箱</label>
                                <div class="controls"><input name="mail" type="text" class="span6 m-wrap"/></div>
                            </div>
                            <div class="control-group">
                                <label class="control-label">电话</label>
                                <div class="controls">
                                    <input name="tel" type="number" class="span6 m-wrap"/>
                                </div>
                            </div>
