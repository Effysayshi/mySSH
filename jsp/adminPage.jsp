                    ...
                    <div class="block-content collapse in">
                        <div class="span12">
                            <div class="table-toolbar">
                                <div class="btn-group">
                                    <a href="postNews.jsp"><button class="btn btn-success">增加资讯<i class="icon-plus icon-white"></i></button></a>
                                </div>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example2">
                                ...
                                <s:iterator value="list" var="d">
                                    <tr class="odd gradeX">
                                        <td><s:property value="#d.newstitle"/></td>
                                        ...
                                        <td class="center">
                                            <a href="news_managerCheck?id=<s:property value="#d.id"/>">查看</a> |
                                            <a href="news_delete?id=<s:property value="#d.id"/>">删除</a>
                                        </td>
